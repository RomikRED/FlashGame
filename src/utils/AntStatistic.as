package utils
{
	...
	public class AntStatistic extends Object
	{
		...
		public static function track(aStatKey:String, aValue:int):void
		{
			...
			{
				trace("(!) Stat \"" + aStatKey + "\" is not registered in AntStatistic.", "result");
			}
		}
		...
		public static function saveData():void
		{
			...
			printObject("Save Statistic", stats);//для дебагу
			printObject("Save Awards", awards);//для дебагу
		}
		...
		public static function loadData():void
		{
			...
			printObject("Load Statistic", stats);//для дебагу
			...
			printObject("Load Awards", awards);//для дебагу
