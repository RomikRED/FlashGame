		...
		/*public function avoid(circles:Array):void
		{
		    for(var i:int = 0; i < circles.length; i++)
		    {
		        ...
		        if(dotProd > 0)
		        {
					...
					// если вектор датчика пересекает окружность радиусом равным радиус circle + размер буфера
		               ...
		               projection.length < feeler.length)
		            {
						...
						// масштабируем степень воздействия в зависимости от расстояния до припятствия
